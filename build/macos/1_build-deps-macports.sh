...
#FIXME: move MACOSX_DEPLOYMENT_TARGET to inside the "$OPT_PREFIX" != '/opt/homebrew' condition after ScreenCaptureKit support
if [ "$OPT_PREFIX" = '/opt/homebrew' ] && echo "$CI_JOB_NAME" | grep -q 'deps'; then
