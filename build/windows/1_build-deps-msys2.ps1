...
if ($env:VCPKG_ROOT)
  {
    ...
    self_build https://gitlab.gnome.org/GNOME/gegl bruno/gegl-clean @('build\windows\patches\0001-libs-operations-meson-Do-not-build-CTX-which-is-Unix.patch', 'build\windows\patches\0001-gegl-Use-vs_module_defs-for-MSVC.patch') @('-Dintrospection=false')
    exit 0
  }
