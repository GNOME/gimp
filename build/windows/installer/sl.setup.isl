...
DevelopmentWarning=To je razvojna razlièica namestitvenega programa za GIMP, ki še ni tako preizkušena kot obièajna razlièica. Èe naletite na kakršne koli težave pri namestitvi, jih prosim sporoèite v Bugzilli (komponenta Installer):%n_https://bugzilla.gnome.org/enter_bug.cgi?product=GIMP%n%nV tem namestitvenem programu je nekaj znanih napak:%n- odpiranje TIFF datotek ne deluje%n- prikazane velikosti datotek so napaène%nProsimo, da teh napak ne sporoèate.%n%nAli želite vseeno nadaljevati z namestitvijo?
