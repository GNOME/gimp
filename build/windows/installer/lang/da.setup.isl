...
DevelopmentWarning=Dette er en development version af installationsprogrammet til GIMP. Det er ikke blevet testet lige så meget som det stabile installationsprogram, hvilket kan resultere i at GIMP ikke virker korrekt. Rapportér venligst de problemer du støder på i GIMP bugzilla (Installer komponent):%n_https://bugzilla.gnome.org/enter_bug.cgi?product=GIMP%n%nDer er kendte problemer i installationsprogrammet:%n- indlæsning af TIFF-filer virker ikke%n- filstørrelser vises ikke korrekt%nRapportér venligst ikke disse problemer, da vi allerede er opmærksom på dem.%n%nØnsker du alligevel at fortsætte installation?
