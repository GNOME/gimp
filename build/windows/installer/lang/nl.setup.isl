...
DevelopmentWarning=Dit is een ontwikkelingsversie van GIMP installatie. Het is nog niet zoveel getest als de stabiele installatie, dit kan resulteren in GIMP niet optimaal werken. Gelieve problemen die je ondervindt te rapporteren in de GIMP bugzilla (Installatiecomponent):%n_https://bugzilla.gnome.org/enter_bug.cgi?product=GIMP%n%nEr zijn enkele gekende problemen in deze installatie:%n- laden van TIFF bestanden werkt niet%n- bestandgroottes zijn niet juist weergegeven%nGelieve deze problemen niet te rapporteren, omdat we ons daarover al bewust zijn.%n%nWenst u alsnog verder te gaan met de installatie?
