...
DevelopmentWarning=Ez a GIMP telepítõjének fejlesztõi verziója. Nincs annyira tesztelve, mint a stabil telepítõ, emiatt a GIMP hibásan mûködhet. A tapasztalt hibákat a GIMP Bugzillába jelentse (az Installer összetevõ alá):%n_https://bugzilla.gnome.org/enter_bug.cgi?product=GIMP%n%nA telepítõvel kapcsolatos ismert hibák:%n- a TIFF fájlok betöltése nem mûködik%n- a fájlméretek nem mindig jelennek meg megfelelõen%nEzeket a problémákat ne jelentse, már tudunk róluk.%n%nMindenképp folytatja a telepítést?
