 ...
 * Time-stamp: <1997/06/08 22:29:17 narazaki@InetQ.or.jp>
 * Version: 0.88
 *
...
#define PROGRESS_NAME	"vpropagate(0.87): propagating..."
  ...
  if ((image_type == RGBA_IMAGE) | (image_type == GRAYA_IMAGE))
    {
      ...
      gtkW_table_add_toggle (table, "Propagating Alpha Channel", 0, 2, 7,
			     (GtkSignalFunc) gtkW_toggle_update,
			     &propagate_alpha);
