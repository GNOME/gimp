...
/* static  GdkColor yellow_color =      { 0, 0xd6d6, 0xd6d6, 0x0000 };
   static  GdkColor grey_color   =      { 0, 0xd6d6, 0xd6d6, 0xd6d6 };
   */
...
warp_dialog (GDrawable *drawable)
{
  ...
  gtk_tooltips_set_tips (tooltips, option_menu_grad, "Gradient map selection menu");
  ...
  gtk_tooltips_set_tips (tooltips, option_menu_vector, "Fixed-direction-vector map selection menu");
