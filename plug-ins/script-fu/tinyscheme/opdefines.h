    ...
    _OP_DEF(opexe_2, "make-array",                     2,  2,       TST_NATURAL TST_STRING,          OP_MKARRAY          )
    _OP_DEF(opexe_2, "array-length",                   1,  1,       TST_ARRAY,                       OP_ARRAYLEN         )
    _OP_DEF(opexe_2, "array-type",                     1,  1,       TST_ARRAY,                       OP_ARRAYTYPE        )
    _OP_DEF(opexe_2, "array-ref",                      2,  2,       TST_ARRAY TST_NATURAL,           OP_ARRAYREF         )
    _OP_DEF(opexe_2, "array-set!",                     3,  3,       TST_ARRAY TST_NATURAL TST_ANY,   OP_ARRAYSET         )
