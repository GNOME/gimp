...
; The ligma-script-fu-interpreter will nevertheless load the second .scm
; while it is querying the first, executable .scm in the dir.
; The plugin manager queries the first executable,
; and ligma-script-fu-interpreter loads (and returns defined names in)
...
(define (script-fu-test3)
  (ligma-message "Hello script-fu-test3")
)
