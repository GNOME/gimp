/**********************************************************************
    Fractal Explorer Plug-in (Version 2.00 Beta)
...
/*  
  ...
  gtk_signal_connect (GTK_OBJECT (button), "button_press_event",
		      ...
		      "My New Fractal");
  gtk_widget_show(button);
  gtk_tooltips_set_tips(tips,button,msg[lng][MSG_NEW_COMMENT]); 
  ...
  gtk_signal_connect (GTK_OBJECT (button), "button_press_event",
		      ...
		      (gpointer) list);
  gtk_tooltips_set_tips(tips,button,msg[lng][MSG_RENAME_COMMENT]); 
...
*/
  ...
  gtk_signal_connect (GTK_OBJECT (button), "button_press_event",
		      ...
		      (gpointer)list);
  gtk_widget_show(button);
  gtk_tooltips_set_tips(tips,button,msg[lng][MSG_DELETE_COMMENT]); 
...
*/  
  ...
  current_obj = g_list_nth(fractalexplorer_list,pos)->data;
