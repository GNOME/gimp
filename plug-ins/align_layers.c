 ...
 * Time-stamp: <1997/06/08 22:28:57 narazaki@InetQ.or.jp>
 * Version:  0.24
 *
...
static void	gtkW_gint_update (GtkWidget *widget, gpointer data);
static void	gtkW_scale_update (GtkAdjustment *adjustment, double *data);
...
static void	gtkW_wrapped_toggle_update (GtkWidget *widget, gpointer data);
...
static void
gtkW_wrapped_toggle_update (GtkWidget *widget,
			    gpointer   data)
{
