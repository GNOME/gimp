/**********************************************************************
 *  Julia Chaos Fractal Explorer Plug-in (Version 1.00)
               ...
               toggle_vbox = gtk_vbox_new (FALSE, 0);
                  ...
                  gtk_container_add (GTK_CONTAINER (frame), toggle_vbox);
             	  ...
             	  table = gtk_table_new(7, 7, FALSE);
                     ...
                     dialog_create_value("CX", GTK_TABLE(table), 5, &wvals.cx,-5,5);
                     dialog_create_value("CY", GTK_TABLE(table), 6, &wvals.cy,-5,5);
                  gtk_widget_show(table);
