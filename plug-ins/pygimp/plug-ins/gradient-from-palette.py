...
def gradient_from_palette_range(palette, first_index, last_index,
                                new_grad_type, sort, invert):

    type_format_str = [_('Normal'), _('Cyclic'), _('Discrete')]
...
def gradient_from_palette(palette):
    ...
    gradient_from_palette_range(palette,
                                0,
...
register(
    'python-fu-gradient-from-palette-range',
    ...
    '2018',
    N_('Gradient from palette range...'),
    '',
    [
