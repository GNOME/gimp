      ...
      if (! g_strcmp0 (widget_name, struct_element[sct].add_widget))
        {
          ...
          g_signal_handlers_block_by_func (G_OBJECT (combo), G_CALLBACK (page_administration_combobox_changed_callback), builder);
          ...
          g_signal_handlers_unblock_by_func(G_OBJECT (combo), G_CALLBACK (page_administration_combobox_changed_callback), builder);
