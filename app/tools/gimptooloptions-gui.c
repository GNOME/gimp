...
GtkWidget *
ligma_tool_options_gui (LigmaToolOptions *tool_options)
{
  GtkWidget *vbox;

  g_return_val_if_fail (LIGMA_IS_TOOL_OPTIONS (tool_options), NULL);
...
GtkWidget *
ligma_tool_options_empty_gui (LigmaToolOptions *tool_options)
{
