      ...
      if (config->dock_window_hint == GIMP_WINDOW_HINT_UTILITY)
        {
          ...
          if (ns_window)
            {
              /* keep dockable window transient (since gimp_widget_set_auto_transient don't work well
                 here: e.g. it makes dockables in front of main window dialogs, which is wrong)*/
