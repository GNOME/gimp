...
#define GIMP_CONTAINER_MENU(obj)            (GTK_CHECK_CAST ((obj), GIMP_TYPE_CONTAINER_MENU, GimpContainerMenu))
#define GIMP_CONTAINER_MENU_CLASS(klass)    (GTK_CHECK_CLASS_CAST ((klass), GIMP_TYPE_CONTAINER_MENU, GimpContainerMenuClass))
#define GIMP_IS_CONTAINER_MENU(obj)         (GTK_CHECK_TYPE ((obj), GIMP_TYPE_CONTAINER_MENU))
#define GIMP_IS_CONTAINER_MENU_CLASS(klass) (GTK_CHECK_CLASS_TYPE ((klass), GIMP_TYPE_CONTAINER_MENU))
