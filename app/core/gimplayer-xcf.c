 ...
 * @layer:          a pointer to #GimpLayer object which will be
 *                  replaced by a new layer of type @new_layer_type.
                       ...
                       ...)
{
  ...
  g_return_if_fail (g_type_is_a (new_layer_type, GIMP_TYPE_LAYER));
  ...
  gimp_drawable_steal_buffer (GIMP_DRAWABLE (new_layer), (GimpDrawable **) layer);
