...
gimp_undo_type_get_type (void)
{
  static const GEnumValue values[] =
  {
    ...
    { GIMP_UNDO_GROUP_SHAPE, "GIMP_UNDO_GROUP_SHAPE", "group-shape" },
    ...
    { GIMP_UNDO_SHAPE_LAYER, "GIMP_UNDO_SHAPE_LAYER", "shape-layer" },
    { GIMP_UNDO_SHAPE_LAYER_MODIFIED, "GIMP_UNDO_SHAPE_LAYER_MODIFIED", "shape-layer-modified" },
  ...
  static const GimpEnumDesc descs[] =
  {
    ...
    { GIMP_UNDO_GROUP_SHAPE, N_("Shape"), NULL },
    ...
    { GIMP_UNDO_SHAPE_LAYER, N_("Shape"), NULL },
    { GIMP_UNDO_SHAPE_LAYER_MODIFIED, N_("Shape modified"), NULL },
