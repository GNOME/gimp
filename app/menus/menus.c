...
static GimpItemFactoryEntry image_entries[] =
{
  ...
  { { N_("/Image/Transforms/tearoff1"), NULL, tearoff_cmd_callback, 0, "<Tearoff>" },
    NULL, NULL },
  { { N_("/Image/Transforms/Offset"), "<control><shift>O", channel_ops_offset_cmd_callback, 0 },
