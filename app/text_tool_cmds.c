		       ...
		       gboolean  antialias)
{
  ...
  g_snprintf (size_buffer, sizeof (size_buffer), "%d", (int) size);
  g_snprintf (xres_buffer, sizeof (xres_buffer), "%d", (int) xresolution);
  g_snprintf (yres_buffer, sizeof (yres_buffer), "%d", (int) yresolution);
