...
gimp_gui_config_class_init (GimpGuiConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_HIDE_TABS,
                                   g_param_spec_boolean ("hide-tabs",
                                                         NULL,
                                                         HIDE_TABS_BLURB,
                                                         FALSE,
                                                         G_PARAM_READWRITE |
                              ...
                              GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_SINGLE_WINDOW_MODE:
      ...
      break;
    case PROP_HIDE_TABS:
      gui_config->hide_tabs = g_value_get_boolean (value);
      break;
                              ...
                              GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_SINGLE_WINDOW_MODE:
      ...
      break;
    case PROP_HIDE_TABS:
      g_value_set_boolean (value, gui_config->hide_tabs);
      break;
    case PROP_TABS_POSITION:
