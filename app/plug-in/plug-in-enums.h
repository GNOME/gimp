...
typedef enum
{
  ...
  GIMP_PLUG_IN_CMYK_IMAGE     = 1 << 1,
  GIMP_PLUG_IN_GRAY_IMAGE     = 1 << 2,
  GIMP_PLUG_IN_INDEXED_IMAGE  = 1 << 3,
  GIMP_PLUG_IN_RGBA_IMAGE     = 1 << 4,
  GIMP_PLUG_IN_CMYKA_IMAGE    = 1 << 5,
  GIMP_PLUG_IN_GRAYA_IMAGE    = 1 << 6,
  GIMP_PLUG_IN_INDEXEDA_IMAGE = 1 << 7
} GimpPlugInImageType;
