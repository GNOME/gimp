 ...
 * Copyright (C) 2010 Øyvind Kolås <pippin@ligma.org>
...
#include "app/operations/ligma-operations.h"
      ...
      gchar ** argv)
{
  ...
  gegl_init (&argc, &argv);
  ligma_operations_init ();
  g_test_init (&argc, &argv, NULL);

  g_test_add_func ("/ligma-operations", test_operations);
