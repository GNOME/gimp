...
static void   view_actions_set_zoom          (LigmaActionGroup   *group,
                                              LigmaDisplayShell  *shell);
static void   view_actions_set_rotate        (LigmaActionGroup   *group,
                                              LigmaDisplayShell  *shell);
static void   view_actions_check_type_notify (LigmaDisplayConfig *config,
                                              GParamSpec        *pspec,
                                              LigmaActionGroup   *group);


static const LigmaActionEntry view_actions[] =
{
  ...
  { "view-scroll-center", LIGMA_ICON_CENTER,
    ...
    LIGMA_HELP_VIEW_SCROLL_CENTER },

  { "view-zoom-fit-in", LIGMA_ICON_ZOOM_FIT_BEST,
    ...
    LIGMA_HELP_VIEW_ZOOM_FIT_IN },

  { "view-zoom-fill", LIGMA_ICON_ZOOM_FIT_BEST,
    ...
    LIGMA_HELP_VIEW_ZOOM_FILL },

  { "view-zoom-selection", LIGMA_ICON_SELECTION,
    ...
    LIGMA_HELP_VIEW_ZOOM_SELECTION },
  ...
  { "view-reset", LIGMA_ICON_RESET,
    ...
    LIGMA_HELP_VIEW_RESET },

  { "view-navigation-window", LIGMA_ICON_DIALOG_NAVIGATION,
  ...
  { "view-display-filters", LIGMA_ICON_DISPLAY_FILTER,
  ...
  { "view-color-management-reset", LIGMA_ICON_RESET,
  ...
  { "view-shrink-wrap", LIGMA_ICON_ZOOM_FIT_BEST,
...
static const LigmaToggleActionEntry view_toggle_actions[] =
{
  ...
  { "view-show-selection", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SHOW_SELECTION },
  ...
  { "view-show-layer-boundary", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SHOW_LAYER_BOUNDARY },
  ...
  { "view-show-canvas-boundary", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SHOW_CANVAS_BOUNDARY },
  ...
  { "view-show-sample-points", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SHOW_SAMPLE_POINTS },
  ...
  { "view-snap-to-guides", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SNAP_TO_GUIDES },
  ...
  { "view-snap-to-canvas", NULL,
    ...
    FALSE,
    LIGMA_HELP_VIEW_SNAP_TO_CANVAS },
  ...
  { "view-snap-to-vectors", NULL,
    ...
    FALSE,
    LIGMA_HELP_VIEW_SNAP_TO_VECTORS },
  ...
  { "view-show-scrollbars", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SHOW_SCROLLBARS },
  ...
  { "view-show-statusbar", NULL,
    ...
    TRUE,
    LIGMA_HELP_VIEW_SHOW_STATUSBAR },

  { "view-fullscreen", LIGMA_ICON_VIEW_FULLSCREEN,
    NC_("view-action", "Fullscr_een"), "F11",
    NC_("view-action", "Toggle fullscreen view"),
    view_fullscreen_cmd_callback,
    FALSE,
    LIGMA_HELP_VIEW_FULLSCREEN }
};

static const LigmaEnumActionEntry view_zoom_actions[] =
{
  { "view-zoom", NULL,
...
static const LigmaRadioActionEntry view_zoom_explicit_actions[] =
{
  ...
  { "view-zoom-1-1", LIGMA_ICON_ZOOM_ORIGINAL,
    NC_("view-zoom-action", "_1:1  (100%)"), "1",
    NC_("view-zoom-action", "Zoom 1:1"),
    10000,
    LIGMA_HELP_VIEW_ZOOM_100 },

  { "view-zoom-1-1-accel", LIGMA_ICON_ZOOM_ORIGINAL,
...
static const LigmaToggleActionEntry view_flip_actions[] =
{
  { "view-flip-horizontally", LIGMA_ICON_OBJECT_FLIP_HORIZONTAL,
    NC_("view-action", "Flip _Horizontally"), NULL,
    NC_("view-action", "Flip the view horizontally"),
    view_flip_horizontally_cmd_callback,
    FALSE,
    LIGMA_HELP_VIEW_FLIP },

  { "view-flip-vertically", LIGMA_ICON_OBJECT_FLIP_VERTICAL,
...
static const LigmaEnumActionEntry view_rotate_absolute_actions[] =
{
...
static const LigmaEnumActionEntry view_padding_color_actions[] =
{
  { "view-padding-color-theme", NULL,
    ...
    LIGMA_CANVAS_PADDING_MODE_DEFAULT, FALSE,
    LIGMA_HELP_VIEW_PADDING_COLOR },
  ...
  { "view-padding-color-light-check", NULL,
    ...
    LIGMA_CANVAS_PADDING_MODE_LIGHT_CHECK, FALSE,
    LIGMA_HELP_VIEW_PADDING_COLOR },
  ...
  { "view-padding-color-dark-check", NULL,
    ...
    LIGMA_CANVAS_PADDING_MODE_DARK_CHECK, FALSE,
    LIGMA_HELP_VIEW_PADDING_COLOR },

  { "view-padding-color-custom", LIGMA_ICON_PALETTE,
    NC_("view-padding-color", "_Custom Color..."), NULL,
    NC_("view-padding-color", "Use an arbitrary color"),
    LIGMA_CANVAS_PADDING_MODE_CUSTOM, FALSE,
    LIGMA_HELP_VIEW_PADDING_COLOR },

  { "view-padding-color-prefs", LIGMA_ICON_RESET,
    ...
    LIGMA_CANVAS_PADDING_MODE_RESET, FALSE,
    LIGMA_HELP_VIEW_PADDING_COLOR }
};

static const LigmaToggleActionEntry view_padding_color_toggle_actions[] =
{
...
static const LigmaEnumActionEntry view_scroll_horizontal_actions[] =
{
...
static const LigmaEnumActionEntry view_scroll_vertical_actions[] =
{
...
void
view_actions_setup (LigmaActionGroup *group)
{
  LigmaAction *action;

  ligma_action_group_add_actions (group, "view-action",
                                 view_actions,
                                 G_N_ELEMENTS (view_actions));

  ligma_action_group_add_toggle_actions (group, "view-action",
                                        view_toggle_actions,
                                        G_N_ELEMENTS (view_toggle_actions));

  ligma_action_group_add_enum_actions (group, "view-zoom-action",
                                      view_zoom_actions,
                                      G_N_ELEMENTS (view_zoom_actions),
                                      view_zoom_cmd_callback);

  ligma_action_group_add_radio_actions (group, "view-zoom-action",
  ...
  ligma_action_group_add_enum_actions (group, "view-action",
  ...
  ligma_action_group_add_radio_actions (group, "view-action",
  ...
  ligma_action_group_add_enum_actions (group, "view-padding-color",
                                      view_padding_color_actions,
                                      G_N_ELEMENTS (view_padding_color_actions),
                                      view_padding_color_cmd_callback);

  ligma_action_group_add_toggle_actions (group, "view-padding-color",
   ...
   */
  action = ligma_action_group_get_action (group, "view-zoom-other");

  g_signal_connect (action, "activate",
                    G_CALLBACK (view_zoom_other_cmd_callback),
                    group->user_data);

  g_signal_connect_object (group->ligma->config, "notify::check-type",
                           G_CALLBACK (view_actions_check_type_notify),
                           group, 0);
  view_actions_check_type_notify (LIGMA_DISPLAY_CONFIG (group->ligma->config),
                                  NULL, group);

  if (LIGMA_IS_IMAGE_WINDOW (group->user_data) ||
      LIGMA_IS_LIGMA (group->user_data))
    {
       ...
       *  (see dock-actions.c)
       */
      window_actions_setup (group, LIGMA_HELP_VIEW_CHANGE_SCREEN);
    }
}

void
view_actions_update (LigmaActionGroup *group,
                     gpointer         data)
{
  LigmaDisplay        *display           = action_data_get_display (data);
  LigmaImage          *image             = NULL;
  LigmaDisplayShell   *shell             = NULL;
  LigmaDisplayOptions *options           = NULL;
  ...
  if (display)
    {
      ...
      revert_enabled = ligma_display_shell_scale_can_revert (shell);
      ...
      switch (ligma_color_config_get_mode (color_config))
        {
      ...
      switch (ligma_color_config_get_display_intent (color_config))
        {
      ...
      d_bpc  = ligma_color_config_get_display_bpc (color_config);
      gamut  = ligma_color_config_get_simulation_gamut_check (color_config);
    }
...
#define SET_COLOR(action,color) \
  ...
  if (revert_enabled)
    {
      ...
      ligma_action_group_set_action_label (group, "view-zoom-revert", label);
      g_free (label);
    }
  else
    {
      ligma_action_group_set_action_label (group, "view-zoom-revert",
                                          _("Re_vert Zoom"));
    }
  ...
  if (display && options->padding_mode != LIGMA_CANVAS_PADDING_MODE_DEFAULT)
...
static void
view_actions_set_zoom (LigmaActionGroup  *group,
                       LigmaDisplayShell *shell)
{
  const gchar *action = NULL;
  gchar       *str;
  ...
  scale = ROUND (ligma_zoom_model_get_factor (shell->zoom) * 1000);
  ...
  ligma_action_group_set_action_label (group, "view-zoom-menu", label);
  g_free (label);
...
static void
view_actions_set_rotate (LigmaActionGroup  *group,
                         LigmaDisplayShell *shell)
{
  const gchar *flip;
  gchar       *label;
  ...
  ligma_action_group_set_action_label (group, "view-rotate-menu", label);
  g_free (label);
}

static void
view_actions_check_type_notify (LigmaDisplayConfig *config,
                                GParamSpec        *pspec,
                                LigmaActionGroup   *group)
{
  ligma_action_group_set_action_color (group, "view-padding-color-light-check",
                                      ligma_render_check_color1 (),
                                      FALSE);
  ligma_action_group_set_action_color (group, "view-padding-color-dark-check",
