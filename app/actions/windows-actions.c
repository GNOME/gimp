...
static const GimpToggleActionEntry windows_toggle_actions[] =
{
  ...
  { "windows-hide-tabs", NULL,
    NC_("windows-action", "Hide Tabs"), NULL,
    NC_("windows-action", "When enabled, the image tab bar is hidden."),
    G_CALLBACK (windows_hide_tabs_cmd_callback),
    FALSE,
    GIMP_HELP_WINDOWS_HIDE_TABS },
...
#define SET_ACTIVE(action,condition) \
  ...
  SET_ACTIVE ("windows-hide-tabs", config->hide_tabs);
  ...
  gimp_action_group_set_action_sensitive (group, "windows-hide-tabs", config->single_window_mode);
