...
static const GimpActionEntry plug_in_actions[] =
{
  ...
  { "plug-in-distort-menu",           NULL, N_("_Distort")          },
  { "plug-in-transform-menu",         NULL, N_("_Transform")        },
  { "plug-in-transparency-menu",      NULL, N_("_Transparency")     },
  { "plug-in-pointillize-menu",       NULL, N_("Po_intillize")      },
  { "plug-in-artistic-menu",          NULL, N_("_Artistic")         },
  { "plug-in-tiling-menu",            NULL, N_("_Tiling")           },
