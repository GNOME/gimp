...
typedef void (* LigmaRunGradientCallback)   (const gchar   *gradient_name,
                                            gint           width,
...
const gchar * ligma_gradient_select_new     (const gchar             *title,
                                            const gchar             *gradient_name,
                                            gint                     sample_size,
                                            LigmaRunGradientCallback  callback,
                                            gpointer                 data,
                                            GDestroyNotify           data_destroy);
void          ligma_gradient_select_destroy (const gchar             *gradient_callback);
