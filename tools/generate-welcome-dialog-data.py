...
infile      = os.path.join(desktop_dir, 'org.ligma.LIGMA.appdata.xml.in.in')
...
if __name__ == "__main__":
  ...
  top_comment = '''/* LIGMA - The GNU Image Manipulation Program
 ...
 ***********************************************************************
 *
 * Modify the python script or desktop/org.ligma.LIGMA.appdata.xml.in.in
 * instead of this one
...
'''
  ...
  if args.header:
    ...
    print('extern gint          ligma_welcome_dialog_n_items;')
    print('extern const gchar * ligma_welcome_dialog_items[];')
    print('extern const gchar * ligma_welcome_dialog_demos[];')
    print()
    print('extern gint          ligma_welcome_dialog_intro_n_paragraphs;')
    print('extern const gchar * ligma_welcome_dialog_intro[];')
    ...
    print('const gint   ligma_welcome_dialog_n_items = {};'.format(len(demos)))
    print()
    print('const gchar *ligma_welcome_dialog_items[] =')
    print('{')
    for item in items:
      print('  "{}",'.format(item))
    print('  NULL,\n};')
    print()
    print('const gchar *ligma_welcome_dialog_demos[] =')
    print('{')
    for demo in demos:
      if demo is None:
        print('  NULL,')
    ...
    print('  NULL,\n};')
    print()
    print('const gint   ligma_welcome_dialog_intro_n_paragraphs = {};'.format(len(intro_p)))
    print()
    print('const gchar *ligma_welcome_dialog_intro[] =')
    print('{')
    for p in intro_p:
      print('  "{}",'.format(p))
    print('  NULL,\n};')
