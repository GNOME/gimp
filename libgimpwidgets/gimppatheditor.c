...
gimp_path_editor_init (GimpPathEditor *editor)
{
  ...
  image = gtk_image_new_from_icon_name (GIMP_STOCK_NEW, GTK_ICON_SIZE_BUTTON);
  ...
  image = gtk_image_new_from_icon_name (GIMP_STOCK_UP, GTK_ICON_SIZE_BUTTON);
  gtk_container_add (GTK_CONTAINER (button), image);
  gtk_widget_show (image);
  ...
  image = gtk_image_new_from_icon_name (GIMP_STOCK_DOWN, GTK_ICON_SIZE_BUTTON);
  gtk_container_add (GTK_CONTAINER (button), image);
  gtk_widget_show (image);
  ...
  image = gtk_image_new_from_icon_name (GIMP_STOCK_DELETE, GTK_ICON_SIZE_BUTTON);
  gtk_container_add (GTK_CONTAINER (button), image);
  gtk_widget_show (image);
